...
export class CreateWebSourceConfigs1783237541754 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "web_source_configs" ADD CONSTRAINT "FK_c69de40360a697ee02b17d51355" FOREIGN KEY ("sourceId") REFERENCES "sources"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "web_source_configs" DROP CONSTRAINT "FK_c69de40360a697ee02b17d51355"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."sources_type_enum_old" AS ENUM('rss', 'atom', 'github_release')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."web_source_configs_preferredextractionmethod_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."web_source_configs_preferreddiscoverymethod_enum"`,
    );
  }
}
