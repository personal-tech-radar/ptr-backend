...
export class AddContentExtractionFieldsToArticles1783192888805 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."articles_contentextractionmethod_enum" AS ENUM('rss', 'readability', 'cheerio_selector', 'playwright')`);
        await queryRunner.query(`ALTER TABLE "articles" ADD "contentExtractionMethod" "public"."articles_contentextractionmethod_enum" NOT NULL DEFAULT 'rss'`);
