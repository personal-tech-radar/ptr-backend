...
import { AdminUserContentStreamsController } from './admin-user-content-streams.controller';
...
describe('AdminUserContentStreamsController guard wiring', () => {
  it('protects the whole controller with HybridAuthGuard + RolesGuard, admin only', () => {
    const guards: unknown = Reflect.getMetadata(GUARDS_METADATA, AdminUserContentStreamsController);
